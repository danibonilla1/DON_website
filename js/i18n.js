...
var englishTranslations = {
  ...
  "hero.hook": "If you've ever felt different, this story is for you.",
  "book.spine": "DIARY OF A BLACK SHEEP",
  "book.inner.title": "For those who<br>felt different",
  "book.inner.author": "by Dani Bonilla",
  "book.back.quote": "Have you ever felt different? You know... the odd one, the one out of the ordinary.<br>My name is...",
  ...
  "page.intro.p2": "For a long time I didn't understand why I felt this way, but maybe the best place to start is the way I came into this world...",
  ...
  "pricing.delivery": "Est. Delivery: Periodic chapter release",
  ...
  "pricing.tier1.subtitle": "Author's Edition",
  "pricing.tier1.title": "The complete saga",
  "pricing.tier1.description": "The deep stories beyond my videos. Told in a way only literature can. Chapters delivered in real time as I create them.",
  "pricing.tier1.guarantee": "Files yours forever",
  "pricing.tier1.cta": "Start now",
  "pricing.tier1.delivery": "Chapters delivered episodically",

  "pricing.tier1.feature1": "Author Voice Notes",
  "pricing.tier1.feature1.details": "Brief notes accompanying each chapter. Personal reflections, additional context, and exclusive voice notes. <strong>Note:</strong> The full narrated audiobook will come in the future as a separate product. This edition includes exclusive voice notes, not text narration.",
  "pricing.tier1.feature2": "The Complete Manuscript (Ebook)",
  ...
  "pricing.tier2.feature4": "Everything in The Complete Saga included",
  ...
  "pricing.tier3.feature3": "Full Access: The Saga + The Creator's Kit",
  "pricing.tier2.delivery": "Est. delivery April 1",
  "pricing.tier3.delivery": "Est. delivery April 1",
  ...
  "pricing.notify_me.text": "Notify me of updates or when the work is complete",
  ...
  "secret.ebook.delivery": "Est. Delivery: Periodic release",
  ...
  "faq.q4.answer": "It's a <strong>presale</strong>. Delivery: <strong>Periodic chapter release</strong>. You'll receive emails with new chapters as they are ready.",
  ...
  "faq.new.q5.question": "Is there a refund guarantee?",
  "faq.new.q5.answer": "<strong>Pre-sale Guarantee:</strong> Full refund if you decide to opt out before I send the first delivery (April 1). Once the first phase is delivered, there are no refunds.",
  "faq.new.q6.question": "What does \"Periodic Delivery\" mean?",
  "faq.new.q6.answer": "It means you don't have to wait until the end. You will receive the work <strong>chapter by chapter</strong> (or in blocks) directly to your email as I finish them. You will live the story in real time.",

  "faq.tech.q1.question": "What happens if the delivery date is delayed?",
  "faq.tech.q1.answer": "Estimated delivery: <strong>Periodic release starting March 2026</strong>. If there's any delay due to production, I'll notify you by email. You're buying a presale with a discount for trusting early.",
  ...
  "archive.title": "Archive Map",
  "archive.subtitle": "Each story has its own journey. Here you can see where each one stands.",
  "archive.status.inProgress": "In Progress",
  "archive.status.published": "Published",
  "archive.status.pending": "Not yet written",
  "archive.delivery": "Delivery: April 1, 2026",
  "archive.pending": "Pending",
  "archive.note": "Coming from a specific video? If the story you're looking for isn't written yet, you can reserve \"The Immersive Journey\" to receive all stories as they are published.",
  "archive.story.usa.title": "United States",
  "archive.story.usa.desc": "My dark experience in the United States. The complete story of what I lived there.",
  "archive.story.paris.title": "Paris",
  "archive.story.paris.desc": "The months I spent in the city of light. Coming soon.",
  "archive.story.espana.title": "Spain",
  "archive.story.espana.desc": "My life in Spain. Origins and roots.",
  "archive.story.suiza.title": "Switzerland",
  "archive.story.suiza.desc": "My new life in Switzerland. The story continues.",

  "archive.toggle": "📚 Looking for a specific story?",
  "archive.subtitle": "The story you're looking for might not be available yet.",
  "archive.book1.title": "📘 Book 1: Dense Wool (The Origin)",
  "archive.book1.desc": "Childhood, family trauma, and adolescent refuges. The prequel to understand the wounds.",
  "archive.book2.title": "📗 Book 2: Among Wolves (The Flight)",
  "archive.book2.desc": "From Michigan to India. The hero's journey across the world. 12 chapters covering my American adventure to the pandemic.",
  "archive.book3.title": "📕 Book 3: Without a Flock (The Ending)",
  "archive.book3.desc": "The spiritual journey (Ayahuasca), the final fall, and the rebirth as a Grey Sheep."
};
