...
var spanishTranslations = {
  ...
  "hero.subtitle": "El viaje que viviste en mis vídeos... ahora completo",
  "hero.author": "por Dani Bonilla",
  "hero.cta": "Continúa el viaje",
  "hero.hook": "Para aquellos que nunca encajaron realmente.",
  "book.spine": "DIARIO DE UNA OVEJA NEGRA",
  "book.inner.title": "Para los que<br>se sintieron diferentes",
  "book.inner.author": "por Dani Bonilla",
  "book.back.quote": "¿Alguna vez te has sentido diferente? Ya sabes, el raro, el fuera de lo normal.<br>Mi nombre es Leín y desde que recuerdo me he sentido como una oveja negra...",
  "page.intro.title": "Introducción",
  "page.intro.p1": "¿Alguna vez te has sentido diferente al resto? Ya sabes... el raro, el extraño, la oveja negra.",
  "page.intro.p2": "Mi nombre es Leín. Durante mucho tiempo no entendí por qué, pero quizás el mejor lugar para empezar es la forma en que llegué a este mundo...",
  ...
  "author.stats": "Dani Bonilla • Storyteller • Creador Internacional",
  ...
  "author.bio1": "Dani es un creador de contenido apasionado por la narración. Ha pasado más de una década creando historias profundas e introspectivas. Su viaje comenzó desde su cuarto, solo—un joven con una cámara y la necesidad de entender quién es él y cómo funciona el mundo. Lo que comenzó como una búsqueda personal de significado se convirtió en una misión para ayudar a otros con su propia experiencia.",
  "author.quote": "Mi propósito es conectar profundamente a través de historias: ser un espejo, una chispa, y un momento de transformación interior. Este libro es la culminación de todo lo que he aprendido.",
  ...
  "footer.copyright": "© Dani Bonilla. Todos son productos de la expresión artística del autor.",
  "footer.disclaimer": "Ficción autobiográfica. Los nombres, personajes, lugares e incidentes son productos de la expresión artística del autor.",
  "pricing.eyebrow": "Tu forma de vivir la historia",
  ...
  "pricing.tier1.title": "El Viaje Inmersivo",
  "pricing.tier1.description": "La conexión que sientes en mis vídeos, multiplicada. Más de 10 horas de inmersión completa. Tuya para siempre.",
  ...
  "pricing.tier1.feature1.details": "Audiolibro narrado por el autor (versión completa). Más de 10 horas de narración íntima y directa. Mi voz contando mi historia con edición de audio limpia y profesional.",
  ...
  "pricing.tier2.title": "El Kit del Creador",
  "pricing.tier2.description": "Mi proceso creativo completo: cómo transformé el dolor en páginas, las herramientas que usé, y cada decisión detrás de la historia. Todo lo de El Viaje Inmersivo incluido.",
  ...
  "pricing.tier2.feature4": "Todo lo de El Viaje Inmersivo incluido",
  ...
  "pricing.tier3.title": "El Círculo Interno",
  ...
  "pricing.tier2.cta": "Obtener el Kit",
  "pricing.tier3.cta": "Unirme al Círculo",
  ...
  "pricing.tier3.feature3": "Todo lo de El Kit del Creador incluido",
  ...
  "pricing.tier3.feature2.details": "Tu nombre o alias quedará inmortalizado como patrocinador en la obra. Tú decides: nombre real, alias, o anónimo. Orden de créditos por contribución.",
  ...
  "pricing.secret_door.text": "¿Solo quieres leer? Opción solo texto disponible — o descarga una muestra",
  "secret.ebook.subtitle": "Lectura Digital",
  "secret.ebook.title": "Edición Texto",
  "secret.ebook.description": "Accede a las 500+ páginas en formato solo texto (PDF/EPUB). El libro será tuyo para siempre. Contribución directa al autor.",
  ...
  "pricing.trust.direct.title": "100% Apoyo",
  "pricing.trust.direct.desc": "Cada euro va al creador",
  "manifesto.text1": "Esto es para todos aquellos que nunca encajaron del todo.",
  "manifesto.text2": "Para los que siempre se sintieron diferentes, que veían el mundo con otros ojos y se preguntaban por qué nadie más parecía verlo igual. Para los que aprendieron a esconder partes de sí mismos, que cargaron con la sensación de ser un extraño, incluso entre los suyos.",
  "manifesto.text3": "",
  ...
  "manifesto.youtube": "Probablemente has llegado aquí desde uno de mis vídeos. Lo has hecho porque has sentido algo diferente: la profundidad, el mensaje... Este viaje es todo lo que no cabía en un solo vídeo de YouTube. Sin algoritmos. Sin pausas publicitarias.",
  ...
  "faq.new.q1.question": "¿Qué pasa si pago y nunca terminas la obra?",
  ...
  "faq.new.q2.answer": "En YouTube tienes fragmentos diseñados para el algoritmo. Esto es la <strong>experiencia completa</strong>: horas de conexión sin interrupciones, la misma calidad emocional pero más profundidad. Es la diferencia entre un vistazo y el viaje completo.",
  ...
  "faq.tech.q3.answer": "Los impuestos se calculan <strong>automáticamente en el checkout</strong> según tu país. La plataforma cobra en USD, así que tu banco hará la conversión de dólares a tu moneda local. Tu banco puede aplicar una pequeña comisión por conversión.",
  "faq.tech.q4.question": "¿Qué NO incluye la compra?",
  "faq.tech.q4.answer": "Esto es una <strong>obra digital terminada</strong>, no un programa ni mentoría. No incluye: soporte técnico 1:1, sesiones personalizadas, envío físico, ni comunidad/llamadas. Para problemas con la plataforma, la plataforma de venta puede ofrecer soporte."
};
